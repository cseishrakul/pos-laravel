                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 mx-auto">
                                            <form action="{{ route('update.category',$category->id) }}" class="forms-sample" method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="">Category Name</label>
                                                    <input type="text" name="cat_name" id="" class="form-control" value="{{$category->cat_name}}">
                                                </div>
