        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row mb-4">
                        <div class="col-md-9">
                            <a href="" class="text-dark" style="text-decoration: none">View Attendence</a>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('admin.dashboard') }}" class="text-dark"
                                style="text-decoration: none">Home</a> /
                            <a href="{{ route('all.attendence') }}" class="" style="text-decoration: none">All
                                Attendence</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">View Attendence ({{ $date->att_date }})</h4>
                                            ...
                                            <tbody>
                                                    @foreach ($data as $row)
                                                        <tr>
                                                            ...
                                                            <td>{{ $row->name }}</td>
                                                            <td>
                                                                <input disabled type="radio" name="attendence[{{ $row->id }}]"
