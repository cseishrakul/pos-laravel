                                            ...
                                            <tbody>
                                                @foreach ($employee as $row)
                                                    <tr>
                                                        ...
                                                        <td>{{$row->salary}} Tk</td>
                                                        <td>
                                                            <a href="{{route('view-employee',$row->id)}}" class="btn btn-primary btn-sm"> <i class="fa fa-eye"></i></a>
                                                            <a href="{{route('edit-employee',$row->id)}}" class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i></a>
                                                            <a href="{{route('delete-employee',$row->id)}}" class="btn btn-danger btn-sm" id="delete"> <i class="fa fa-trash"></i></a>
                                                        </td>
