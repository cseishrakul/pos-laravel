                ...
                <div class="content-wrapper">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{ route('add.product') }}" class="" style="text-decoration: none">Orders</a>
                        </div>
                    </div>
                    <div class="row">
                                            ...
                                            <tbody>
                                                @foreach ($pending as $row)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('view-order-status',$row->id)}}" class="btn btn-primary btn-sm"> <i class="fa fa-eye"></i></a>
